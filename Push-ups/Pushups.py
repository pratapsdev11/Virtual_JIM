...
with  md_pose.Pose(
    ...
    while cap.isOpened():
        ...
        cv2.putText(image,'COUNT',(170,12),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,0,0),1,cv2.LINE_AA)
        cv2.putText(image,str(count),(200,40),cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),1,cv2.LINE_AA)             
